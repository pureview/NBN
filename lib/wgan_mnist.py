...
'''
@author: zhouhonggang
@content: 这个版本是用标准的WGAN来实现任意推理，即输入输出都是28*28的浮点数向量
'''
    ...
    def train(self, sample_folder, training_epoches=1000000, batch_size=32):
        ...
        for epoch in range(training_epoches):
            ...
            for _ in range(n_d):
                ...
                random_groups=random.sample(range(28*28),int(self.random_thresh*28*28))
...
if __name__ == '__main__':
    ...
    sample_folder = 'Samples/mnist_standard_wgan'
